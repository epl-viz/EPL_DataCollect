...
class Test_MultipleCN(Plugin.Plugin):       # name your class plugin like your python module, and let it derive from Plugin.Plugin !
  def getID(self):
    return "Test_MultipleCN"                # make sure the getID method returns the exact class name as a str
